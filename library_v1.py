...
class LibraryManagementSystem:
    def __init__(self, root):
        ...
        # =================== DataFrame Right ===================
        DataFrameRight = LabelFrame(frame, text="Book Information", bg="lavender",
                                    fg="black", bd=12, relief=GROOVE, font=("inter", 12, "bold"))
        ...
        DataFrameRight1 = LabelFrame(frame, text="Select PRN", bg="lavender",
                                     fg="black", bd=12, relief=GROOVE, font=("inter", 12, "bold"))
        DataFrameRight1.place(x=1170, y=5, width=520, height=350)

        listScrollbar = Scrollbar(DataFrameRight)
        listScrollbar.grid(row=0, column=1, sticky="ns")
        listScrollbar1 = Scrollbar(DataFrameRight1)
        listScrollbar1.grid(row=1, column=0, sticky="ns")

        listBooks = ['The Hunger Games', 'Harry Potter and the Order of the Phoenix', 'Pride and Prejudice', 'To Kill a Mockingbird', 'The Book Thief', 'Twilight', 'Animal Farm',
                     'The Chronicles of Narnia', 'The Fault in Our Stars', 'Gone with the Wind', 'The Giving Tree', 'Wuthering Heights', 'The Picture of Dorian Gray', 'Jane Eyre']
        listPRN = ['1032200803', '1032200804', '1032200805', '1032200806',
                   '1032200807', '1032200808', '1032200809', '1032200810', '1032200811']
        ...
        #listPRN = ['1032200803','1032200804','1032200805','1032200806','1032200807','1032200808','1032200809','1032200810','1032200811','1032200812','1032200813','1032200814']
        ...
        def SelectPRN(event=""):
            ...
            if (x == '1032200803'):
                ...
                self.prn_var.set("1032200803")
                self.id_var.set("0129")
                self.firstname_var.set("Frank")
                self.lastname_var.set("Crystal")
                self.address_var.set("Tornoto")
                self.postcode_var.set("M1L3K7")
                self.mobile_var.set("7234816348")

            elif (x == '1032200804'):
                self.member_var.set("Student")
                self.prn_var.set("1032200804")
                self.id_var.set("0131")
                self.firstname_var.set("Jesus")
                self.lastname_var.set("Garcia")
                self.address_var.set("Abbotsford")
                self.postcode_var.set("V2S2H7")
                self.mobile_var.set("7234845481")

            elif (x == '1032200805'):
                self.member_var.set("Student")
                self.prn_var.set("1032200805")
                self.id_var.set("0132")
                self.firstname_var.set("Habbab")
                self.lastname_var.set("Suleman")
                self.address_var.set("Queens")
                self.postcode_var.set("N3C1H3")
                self.mobile_var.set("8234745481")

            elif (x == '1032200806'):
                self.member_var.set("Student")
                self.prn_var.set("1032200806")
                self.id_var.set("0133")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
                self.mobile_var.set("8234745531")
                ...
                self.member_var.set("Student")
                self.prn_var.set("1032200807")
                self.id_var.set("0134")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
                ...
                self.member_var.set("Student")
                self.prn_var.set("1032200808")
                self.id_var.set("0135")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
                ...
                self.member_var.set("Student")
                self.prn_var.set("1032200809")
                self.id_var.set("0136")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
                ...
                self.member_var.set("Student")
                self.prn_var.set("1032200810")
                self.id_var.set("0137")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
                ...
                self.member_var.set("Student")
                self.prn_var.set("1032200811")
                self.id_var.set("0138")
                self.firstname_var.set("De")
                self.lastname_var.set("Chia")
                self.address_var.set("Saint John")
                self.postcode_var.set("E2L4V1")
        ...
        listBox1 = Listbox(DataFrameRight1, font=(
            "inter", 12, "bold"), width=24, height=15)
        listBox1.bind("<<ListboxSelect>>", SelectPRN)
        listBox1.grid(row=1, column=0, padx=4)
        listScrollbar.config(command=listBox1.yview)
        ...
        btnAddData = Button(FrameButton, text="Show Data", command=self.show_data, font=(
            "inter", 12, "bold"), width=23, bg="dark slate blue", fg="white")
    ...
    def update(self):
        conn = mysql.connector.connect(
            host="localhost", username="root", password="root", database="mydata")
        my_cursor = conn.cursor()
        my_cursor.execute("update library set Member=%s, ID=%s, FirstName=%s, LastName=%s, Address=%s, Postcode=%s,mobile_var=%s, BookId=%s, Mobile=%s, Author=%s, DateBorrowed=%s, datedue=%s, daysofbook=%s, latereturnfine=%s, dateoverdue=%s, finalprice=%s, PRN_NO=%s", (
            self.member_var.get(),
            self.id_var.get(),
            self.firstname_var.get(),
            self.lastname_var.get(),
    ...
    def show_data(self):
        ...
        self.txtBox.insert(END, "PostCode:\t\t" +
                           self.postcode_var.get() + "\n")
